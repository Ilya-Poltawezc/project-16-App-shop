...
export default function Header() {
  return (
    <header className={clsx(styles.header, styles)}>
      <div className={clsx('container', styles.header__titleBlock)}>
        <a className={clsx(styles.header__imgLink)} href="/">
        <img src={logo} alt="SneakMax" />
        </a>
        <ul className={styles.header__title}>
            <li className={clsx(styles.header__item)}>
            ...
            <li className={clsx(styles.header__item)}>
                <a className={clsx(styles.header__linkBac)} href="/">
                    Basket <svg width="20" height="19" viewBox="0 0 20 19" fill="none" xmlns="http://www.w3.org/2000/svg">
