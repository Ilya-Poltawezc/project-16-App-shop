...
export default function ButtonShowDetails() {
    ...
    return (
        <div className={styles.catalog__cardShow}>
        <button onClick={handleClick} className={`${styles.catalog__buttonShow} ${open ? styles.catalog__buttonVissualy : ""}`}>
        ...
        {<div id='catalog' className={`${styles.catalog__title} ${open ? styles.catalog__buttonHide : ""}`}>
